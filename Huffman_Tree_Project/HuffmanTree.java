...
public class HuffmanTree {
   ...
   // in standard format.
   private void writeInternal(HuffmanNode root,PrintStream output) {
      if(root != null) {
   ...
   public HuffmanTree(Scanner input) {
      ...
      while(input.hasNextLine()) {
         ...
         overallRoot = createNodeRecur(overallRoot, code,asciiCharacter, 0);
      }
   }
   ...
   private HuffmanNode createNodeRecur(HuffmanNode node, String code,int asciiChar, int index) {
